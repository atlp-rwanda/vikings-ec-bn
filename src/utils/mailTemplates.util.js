...
<body style="font-family: Arial, sans-serif; font-size: 16px; line-height: 1.5; color: #333; background-color: #f5f5f5;">
  <div style="max-width: 600px; margin: 0 auto; padding: 20px; background-color: #fff;">
    ...
    <div style="display: inline-block; margin-top: 10px; margin-bottom: 10px; padding: 10px; background-color: #f7f7f7; border-radius: 4px; font-size: 18px; font-weight: bold;">${otpCode}</div> to complete the login process, at this link: http://localhost:5000/api/v1/users/login/auth/${id}/verify/</p>
